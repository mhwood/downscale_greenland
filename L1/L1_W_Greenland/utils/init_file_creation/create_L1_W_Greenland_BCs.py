...
def create_BCs(config_dir, L1_model_name,
    ...
    # tile, row, col
    northern_tiles = [0, 0, 0, 10, 11, 12] # put the 0's to have 0'd BCs where model expects it
    southern_tiles = [0, 0, 3, 0, 0, 0] # put the 0's to have 0'd BCs where model expects it
    eastern_tiles = [3, 0, 9, 12]
    western_tiles = []
