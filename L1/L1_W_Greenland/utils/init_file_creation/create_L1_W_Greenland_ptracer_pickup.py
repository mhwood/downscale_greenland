...
def create_ptracer_pickup_file(config_dir, model_name,
    ...
    source = 'ECCO'
    import create_L1_ECCO_ptracer_pickup as cep

    ###################################################################
    # these are the ecco functions

    cep.create_L1_ECCO_ptracer_pickup_file(config_dir, model_name,
                                   ecco_dir, llc,ordered_ecco_tiles, ordered_ecco_tile_rotations,
                                   parent_model_pickup_iteration, print_level, read_darwin=True)
