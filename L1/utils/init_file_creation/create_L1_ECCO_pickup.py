...
def rotate_interpolated_grids_to_domain(var_names,interp_grids, AngleCS, AngleSN):
    ...
    natural_gunm1 = interp_grids[gunm1_grid_index]
    natural_gvnm1 = interp_grids[gvnm1_grid_index]
    gunm1, gvnm1 = rotate_velocity_vectors_to_domain(AngleCS, AngleSN,
                                                     natural_gunm1,natural_gvnm1)
    interp_grids[gunm1_grid_index] = gunm1
    interp_grids[gvnm1_grid_index] = gvnm1

    gunm2_grid_index = var_names.index('GuNm2')
    gvnm2_grid_index = var_names.index('GvNm2')
    natural_gunm2 = interp_grids[gunm2_grid_index]
    natural_gvnm2 = interp_grids[gvnm2_grid_index]
    gunm2, gvnm2 = rotate_velocity_vectors_to_domain(AngleCS, AngleSN,
                                                     natural_gunm2,natural_gvnm2)
    interp_grids[gunm2_grid_index] = gunm2
    interp_grids[gvnm2_grid_index] = gvnm2
...
def create_L1_ECCO_pickup_file(config_dir, model_name,
    ...
    if print_level >= 1:
        print('    - Rotating natural fields back to model geometry')
