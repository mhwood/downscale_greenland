...
def read_domain_face_geometry_from_mitgrid(config_dir, L1_model_name, n_rows, n_cols):
    ...
    file_path = os.path.join(config_dir, 'L1_grid', L1_model_name, 'input', L1_model_name + '.mitgrid')
...
def create_L1_CE_Greenland_bathymetry(config_dir, model_name, ecco_dir, n_rows, n_cols, llc, print_status):
    ...
    bathy_grid_filled = fill_unconnected_areas(bathy_grid)
    ...
    output_file = os.path.join(config_dir, 'L1_grid', model_name, 'input', model_name+'_bathymetry.bin')
