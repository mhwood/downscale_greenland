...
def create_L1_N_Greenland_bathymetry(config_dir, ecco_dir, print_status = 4):

    model_name = 'L1_N_Greenland'
    n_rows = 720
    n_cols = 720 #540 for W
    llc = 1080
    ...
    bathy_file = os.path.join(ecco_dir,'LLC'+str(llc)+'_Files','input_init','bathy'+str(llc)+'_g5_r4')
    ...
    #close off Scoresby Sound
    bathy_grid_filled[471:472,0:15] = 0
    #top problem
    bathy_grid_filled[715:720,250:251] = 0
    ...
    plt.imshow(bathy_grid_filled, origin='lower', vmin=-20, vmax=0)
    plt.show()
    #bathy_grid_filled[430:450,500:]
...
if __name__ == '__main__':
    ...
    create_L1_N_Greenland_bathymetry(config_dir, ecco_dir)
