...
def create_pickup_file(config_dir, ecco_dir, print_level):
    ...
    llc = 270
    ordered_ecco_tiles = [[58, 59], [61, 62]]
    ordered_ecco_tile_rotations = [[0, 0], [0, 0]]

    import create_L1_pickup_3413 as cp
    cp.create_L1_pickup_file(config_dir, L1_model_name,
