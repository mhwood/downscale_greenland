...
def create_dv_masks(config_dir, L1_model_name, print_level):
    ...
    if L2_model_name == "L2_Nares":
        boundaries = ['L2_Nares_north','L2_Nares_south']
    if L2_model_name == 'L2_NEGIS':
        boundaries = ['L2_NEG_south','L2_NEG_east','L2_NEG_north']
    ...
    for boundary in boundaries:
        ...
        if boundary in ['L2_SB_west','L2_SB_north','L2_SB_south','L2_SB_east']:
            ...
            output_file = os.path.join(config_dir, 'L1', L1_model_name, 'input', 'dv', boundary+'_mask.bin')
    ...
    output_file_name = L2_model_name+'_dv_mask_reference_dict.nc'
