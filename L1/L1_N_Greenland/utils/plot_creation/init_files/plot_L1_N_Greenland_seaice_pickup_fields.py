...
def plot_seaice_pickup(config_dir, print_level):
    ...
    import plot_L1_seaice_pickup_fields as pf
    pf.create_seaice_pickup_plot(config_dir, L1_model_name, pickup_iteration)
...
if __name__ == '__main__':
    ...
    plot_seaice_pickup(config_dir, print_level=4)
