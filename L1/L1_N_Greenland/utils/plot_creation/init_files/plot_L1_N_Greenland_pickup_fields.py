...
def plot_pickup(config_dir, print_level):
    ...
    import plot_L1_pickup_fields as pf
    pf.create_pickup_plot(config_dir, L1_model_name, pickup_iteration)
...
if __name__ == '__main__':
    ...
    plot_pickup(config_dir, print_level=4)
