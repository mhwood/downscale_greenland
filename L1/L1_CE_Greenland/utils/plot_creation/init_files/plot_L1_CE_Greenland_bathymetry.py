...
def plot_L1_CE_Greenland_bathymetry(config_dir, L1_model_name, sNx, sNy, faces, face_size_dict):

    sys.path.insert(1, os.path.join(config_dir, 'L1', 'utils', 'plot_creation','init_files'))

    import plot_L1_bathymetry as pmc
    pmc.create_bathymetry_plot(config_dir, L1_model_name, sNx, sNy, faces, face_size_dict)
