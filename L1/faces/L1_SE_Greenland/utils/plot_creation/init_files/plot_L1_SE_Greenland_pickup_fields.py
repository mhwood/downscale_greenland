...
def plot_L1_SE_Greenland_pickup(config_dir, L1_model_name, pickup_iteration,
    ...
    import plot_L1_pickup_fields as ppf
    ppf.create_pickup_plot(Lf, config_dir, L1_model_name, pickup_iteration,
                           sNx, sNy, faces, face_size_dict)
