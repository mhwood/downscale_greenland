...
def read_L1_CE_Greenland_boundary_condition(config_dir, L1_model_name, boundary, field_name, sNx, sNy, Nr, n_timesteps):
...
def plot_L1_CE_Greenland_BCs(config_dir, L1_model_name, sNx, sNy):
