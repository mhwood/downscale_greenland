...
def create_L05_CE_Greenland_mitgrid_files(config_dir, ecco_dir):
    sys.path.insert(1, os.path.join(config_dir, 'L05', 'utils', 'init_file_creation'))
    import create_L05_bathymetry as cb
...
if __name__ == '__main__':
    ...
    create_L05_CE_Greenland_mitgrid_files(config_dir,ecco_dir)
