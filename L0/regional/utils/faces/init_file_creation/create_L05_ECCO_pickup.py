...
def create_L05_ECCO_pickup_file(config_dir,model_name,sNx,sNy,ordered_nonblank_tiles,tile_face_index_dict,
    ...
    pickup_file = 'pickup.'+'{:010d}'.format(L0_iter_number)
    ...
    output_file = os.path.join(output_dir, 'pickup.' + '{:010d}'.format(2*L0_iter_number))
    dtype = '>f8'
