...
def plot_L1_CE_Greenland_init_fields(config_dir):
    ...
    if 8 in steps:
        print('Step 8: Plotting the boundary conditions timeseries for the ' + L1_model_name + ' model')
        import plot_L1_CE_Greenland_BC_timeseries as pbt
        pbt.plot_L1_CE_Greenland_BC_timeseries(config_dir, L1_model_name, sNx, sNy)
