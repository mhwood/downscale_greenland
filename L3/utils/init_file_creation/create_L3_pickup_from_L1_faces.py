...
def create_L3_pickup_file(config_dir, L1_model_name, L1_iteration, L3_model_name,
                           sNx, sNy, ordered_nonblank_tiles, ordered_nonblank_rotations,
                           faces, ordered_tiles_faces_dict, zero_etan, print_level):
    ...
    L3_XC, L3_YC, L3_AngleCS, L3_AngleSN = read_grid_geometry_from_nc(config_dir,L3_model_name)
