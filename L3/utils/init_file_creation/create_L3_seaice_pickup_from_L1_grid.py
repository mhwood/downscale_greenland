...
def create_L3_seaice_pickup_file(config_dir, L1_model_name, L1_iteration, L3_model_name, print_level):

    print('    - Creating the pickup file for the ' + L3_model_name + ' model')
    ...
    for vn in range(len(var_names)):
        ...
        if var_name not in []:  # used for testing
            ...
            domain_wet_cells = read_grid_mask_from_nc(config_dir,L3_model_name,var_name)
