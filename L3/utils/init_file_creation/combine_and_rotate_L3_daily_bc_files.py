    ...
    for dest_file in dest_files:
        ...
        if var_name in ['UVEL','VVEL','UICE','VICE']:
            if 'VEL' in var_name:
                ...
                u_var_grid = np.fromfile(os.path.join(config_dir, 'L3', config_name, 'input', 'obcs',mask_name, 'UVEL', u_dest_file), '>f4')
                u_var_grid = np.reshape(u_var_grid, dest_file_shapes[dest_file])
                v_var_grid = np.fromfile(os.path.join(config_dir, 'L3', config_name, 'input', 'obcs',mask_name, 'VVEL', v_dest_file),'>f4')
            ...
            if 'ICE' in var_name:
                ...
                u_var_grid = np.fromfile(os.path.join(config_dir, 'L3', config_name, 'input', 'obcs',mask_name, 'UICE', u_dest_file), '>f4')
                u_var_grid = np.reshape(u_var_grid, dest_file_shapes[dest_file])
                v_var_grid = np.fromfile(os.path.join(config_dir, 'L3', config_name, 'input', 'obcs',mask_name, 'VICE', v_dest_file),'>f4')
                v_var_grid = np.reshape(v_var_grid, dest_file_shapes[dest_file])
            ...
            var_grid = np.fromfile(os.path.join(config_dir,'L3',config_name, 'input','obcs',mask_name,var_name,dest_file),'>f4')
