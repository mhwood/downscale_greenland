...
def create_seaice_pickup_plot(config_dir, L3_model_name, pickup_iteration):

    input_dir = os.path.join(config_dir,'L3', L3_model_name, 'input')
    ...
    plt.savefig(os.path.join(output_dir, L3_model_name+'_seaice_pickup_fields.png'), bbox_inches='tight')
    plt.close(fig)
