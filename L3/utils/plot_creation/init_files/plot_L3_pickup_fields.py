...
def read_L3_Nr_from_grid(config_dir, model_name):
...
def create_pickup_plot(config_dir, L3_model_name, pickup_iteration):
    ...
    Nr = read_L3_Nr_from_grid(config_dir, L3_model_name)
