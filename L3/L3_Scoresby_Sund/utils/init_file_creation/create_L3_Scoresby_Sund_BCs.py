...
def create_BCs(config_dir, L3_model_name, parent_model, print_level):
    ...
    ebcr.create_L3_BC_ref_file(config_dir, L3_model_name, parent_model, print_level)

    # # step 2: using the reference dict, organize downscaled BC into daily files
    # import create_L3_daily_BC_fields_from_ref as cef
    # for proc_id in range(2, 3):  # 7
    #     cef.create_BC_fields_via_interpolation(config_dir, L3_model_name, parent_model, proc_id,
