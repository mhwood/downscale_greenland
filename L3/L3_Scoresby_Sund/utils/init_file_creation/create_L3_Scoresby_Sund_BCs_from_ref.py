...
def create_BCs(config_dir, proc_id,
    ...
    import create_L3_daily_bcs_from_ref as cbc
    ...
    print('Creating the BCs for the '+L3_model_name+' model')

    # pass to general function to generate mitgrid
    cbc.create_bc_fields_via_interpolation(config_dir, L2_model_name, L3_model_name, proc_id,
