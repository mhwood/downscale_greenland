...
def create_L05_ECCO_seaice_pickup_file(config_dir,model_name,sNx,sNy,ordered_nonblank_tiles,tile_face_index_dict,
    ...
    L0_iter_number = 263016
    pickup_file = 'pickup_seaice.'+'{:010d}'.format(L0_iter_number)
            ...
            for vn in range(len(var_names)):
                ...
                if var_name not in []:  # used for testing
                    ...
                    interp_field = df.downscale_3D_field(ecco_XC, ecco_YC,
                                                         ...
                                                         mean_vertical_difference=0, fill_downward=True, remove_zeros=remove_zeros,
                                                         printing=False)
    ...
    output_file = os.path.join(output_dir, 'pickup_seaice.' + '{:010d}'.format(2*L0_iter_number))
    dtype = '>f8'
