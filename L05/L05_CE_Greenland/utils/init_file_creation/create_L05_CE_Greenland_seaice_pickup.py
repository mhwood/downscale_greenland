...
def create_pickup_file(config_dir):
    ...
    if source=='ASTE':
        import create_L05_ASTE_seaice_pickup as casp
    if source=='ECCO':
        import create_L05_ECCO_seaice_pickup as cesp
    ...
    if source == 'ECCO':
        ...
        cesp.create_L05_ECCO_seaice_pickup_file(config_dir, model_name,
    ...
    if source == 'ASTE':
        ...
        casp.create_L05_ASTE_seaice_pickup_file(config_dir,model_name,
                                       sNx,sNy,ordered_nonblank_tiles,tile_face_index_dict,
