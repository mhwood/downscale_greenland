...
def create_dv_masks(config_dir, L1_model_name, L3_model_name, print_level):
    ...
    ctd_points = np.array([[-55.6241,68.3733], # outer shelf, south
                           [-53.8952,68.6101], # entrance to trough
                           [-53.1101,69.0037], # inside trough
                           [-52.4093,69.1998], # center of the bay
                           [-50.5536,69.1725], # Jak 1
                           [-50.1942,69.1804], # Jak 2
                           [-51.2729,69.9404], # Torsukataq entrance
                           [-50.2907,70.0154], # # Tor, near glaciers
                           [-50.3875,69.8670], # near Kangil
                           [-52.8751,70.1910], # Vaigot
                           [-55.9553,69.4548], # outer shelf central
                            ])

    for boundary in ['CTD',
                     'L3_north','L3_south','L3_west','L3_surface']:
        if print_level >= 1:
