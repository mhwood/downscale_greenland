...
def plot_L1_CE_Greenland_exfs(config_dir, L1_model_name, exf_shape,
    ...
    #
    # import plot_L1_sgd_fields as sgd
    # sgd.create_sgd_plot(Lf, config_dir, L1_model_name, sNx, sNy, faces, face_size_dict)
