...
def create_L2_Nares_files(config_dir):

    L2_model_name = 'L2_Nares'
    ...
    if 1 in steps:
        ...
        import create_L2_Nares_mitgrid as cm
    ...
    if 2 in steps:
        ...
        import create_L2_Nares_bathymetry as cb
    ...
    if np.any(np.array(steps)>2):
        ...
        if not os.path.exists(grid_path):
            sys.exit("Need to make the grid netcdf file for this model for reference\n"
                     "   - Run the stitch_L2_Nares_nc_grid_files_for_ref.py script with the -f 1 flag (and -r 150 -c 210)\n"
                     "   - Run the *for_grid model\n"
                     "   - Run the stitch_L2_Nares_nc_grid_files_for_ref.py script")

    # step 3: make the initial conditions
    if 3 in steps:
        print('Step 3: Creating the pickup (initial conditions) file for the ' + L2_model_name + ' model')
        import create_L2_Nares_pickup as cp
    ...
    if 4 in steps:
        ...
        import create_L2_Nares_seaice_pickup as cp
    ...
    if 5 in steps:
        ...
        import create_L2_Nares_exf as ce
    ...
    if 6 in steps:
        ...
        import create_L2_Nares_BCs as cbc
    ...
    #     glacier_names = ['Saqqarliup','Alangorliup','Jakobshavn','Sermeq Avannarleq (near JI)',
    #                      'Eqip Sermia','Kangilernata','Sermeq Kujalleq','Sermeq Avannarleq']
    #     import create_L2_Nares_iceplume as cip
    ...
    #     import create_L2_Nares_dv_masks as cdv
...
if __name__ == '__main__':
    ...
    create_L2_Nares_files(config_dir)
