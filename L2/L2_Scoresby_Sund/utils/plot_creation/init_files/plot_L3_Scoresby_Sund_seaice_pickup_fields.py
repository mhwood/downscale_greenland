...
def plot_L3_Scoresby_Sund_seaice_pickup(config_dir, pickup_iteration):

    L3_model_name = 'L3_Scoresby_Sund'

    sys.path.insert(1, os.path.join(config_dir, 'L3', 'utils', 'plot_creation', 'init_files'))

    import plot_L3_seaice_pickup_fields as psp
    psp.create_seaice_pickup_plot(config_dir, L3_model_name, pickup_iteration)
...
if __name__ == '__main__':
    ...
    plot_L3_Scoresby_Sund_seaice_pickup(config_dir,pickup_iteration)
