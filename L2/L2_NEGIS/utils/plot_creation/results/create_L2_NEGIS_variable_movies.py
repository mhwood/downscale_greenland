...
def create_movies(config_dir, field_name, print_level):
    ...
    metadata_dict = {'EtaN': [-4, 1, 'viridis', 'm', 'Surface Height Anomaly'],
                     ...
                     'Theta_AW': [-1.9,-1, 'turbo', '$^{\circ}$C', 'Potential Temperature (257 m)'],#
    ...
    pvm.create_variable_movies(config_dir, L2_model_name, field_names, metadata_dict, remove_old, skip, print_level)
