...
def create_all_BCs(config_dir,
    ...
    path = os.path.join(config_dir,'L2','L2_CE_Greenland','utils','init_file_creation','create_L2_CE_Greenland_exf_from_ref.py')
    ...
    # import create_L2_CE_Greenland_exf_from_ref as cex
    #
    # print('Creating all of the BCs for the '+L2_model_name+' model')
    #
