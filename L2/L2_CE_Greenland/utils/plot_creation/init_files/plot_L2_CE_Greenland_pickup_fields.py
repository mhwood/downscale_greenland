...
def plot_L2_CE_Greenland_pickup(config_dir, pickup_iteration):

    L2_model_name = 'L2_CE_Greenland'

    sys.path.insert(1, os.path.join(config_dir, 'L2', 'utils', 'plot_creation', 'init_files'))

    import plot_L2_pickup_fields as pp
    pp.create_pickup_plot(config_dir, L2_model_name, pickup_iteration)
...
if __name__ == '__main__':
    ...
    plot_L2_CE_Greenland_init_fields(config_dir,pickup_iteration)
