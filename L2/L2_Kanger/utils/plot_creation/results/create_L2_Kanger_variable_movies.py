...
def create_movies(config_dir, results_dir, field_name, print_level):

    L2_model_name = 'L2_Kanger'

    sys.path.insert(1, os.path.join(config_dir, 'L2', 'utils','plot_creation','results'))
    ...
    import create_L2_variable_movies as pvm
    pvm.create_variable_movies(config_dir, L2_model_name, results_dir, field_names, metadata_dict, remove_old, skip, print_level)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-r", "--results_dir", action="store",
                        help="The name of the results directory.", dest="results_dir",
                        type=str, required=True)

    parser.add_argument("-f", "--field_name", action="store",
                        help="The directory where the L2, L2, and L2 configurations are stored.", dest="field_name",
                        type=str, required=True)
    ...
    create_movies(config_dir, results_dir, field_name, print_level=4)
